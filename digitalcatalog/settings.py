"""
Django settings for digitalcatalog project.
...
SECRET_KEY = 'django-insecure-pd4rilq*imaa^$-%q(u3r4-j4!#$8#$hv87_71-#f#^*0g(4vi'
...
WSGI_APPLICATION = 'digitalcatalog.wsgi.application'
